...
import com.nayatest.opportunity.APPLY;
import com.nayatest.opportunity.R;
import com.nayatest.opportunity.models.Post;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void AlertDialog(final PostViewHolder holder){
        ...
        btnEnterBid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(HomeActivity.this, APPLY.class));
    ...
    protected void onStart() {
        ...
        mAdapter = new FirebaseRecyclerAdapter<Post, PostViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull final PostViewHolder holder, int position, @NonNull Post model) {
                ...
                holder.stage.setText("Stage:"+model.getStage());
                holder.companyName.setText("Company Name:"+model.getCompanyname());
    ...
    public static class PostViewHolder extends RecyclerView.ViewHolder {
        ...
        public PostViewHolder(View itemView) {
            ...
            amount = itemView.findViewById(R.id.amountm);
            stage = itemView.findViewById(R.id.stagem);
            companyName = itemView.findViewById(R.id.companynamem);
